...
steps:
  ...
  preexist-hypertension-ht---primary:
    run: preexist-hypertension-ht---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  nephropathy-hypertension-ht---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: preexist-hypertension-ht---primary/output
  renal-hypertension-ht---primary:
    run: renal-hypertension-ht---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  hypertension-ht-benign---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: renal-hypertension-ht---primary/output
  ...
  retinopathy-hypertension-ht---primary:
    run: retinopathy-hypertension-ht---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  hypertension-ht-haemorrhage---primary:
    run: hypertension-ht-haemorrhage---primary.cwl
    out:
    - output
    in:
      inputModule:
      ...
      potentialCases:
        id: potentialCases
        source: retinopathy-hypertension-ht---primary/output
  arterial-hypertension-ht---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: hypertension-ht-haemorrhage---primary/output
  ...
  hypertension-ht-heart---primary:
    run: hypertension-ht-heart---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  myocardial-hypertension-ht---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: hypertension-ht-heart---primary/output
  ...
  cerebral-hypertension-ht---primary:
    run: cerebral-hypertension-ht---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  hypertension-ht-embolism---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: cerebral-hypertension-ht---primary/output
