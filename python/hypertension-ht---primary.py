...
codes = [{"code":"6629.00","system":"readv2"},{"code":"662F.00","system":"readv2"},{"code":"662O.00","system":"readv2"},{"code":"9OIA.00","system":"readv2"},{"code":"9OIA.11","system":"readv2"},{"code":"G20..11","system":"readv2"},{"code":"G202.00","system":"readv2"},{"code":"G20z.11","system":"readv2"},{"code":"3053HT","system":"oxmis"},{"code":"401 AC","system":"oxmis"},{"code":"401 AR","system":"oxmis"},{"code":"401 AT","system":"oxmis"},{"code":"401 BM","system":"oxmis"},{"code":"401 BR","system":"oxmis"},{"code":"401 C","system":"oxmis"},{"code":"401 DC","system":"oxmis"},{"code":"401 LB","system":"oxmis"},{"code":"401 NC","system":"oxmis"},{"code":"401 R","system":"oxmis"},{"code":"401 S","system":"oxmis"},{"code":"402 VH","system":"oxmis"},{"code":"403 AH","system":"oxmis"},{"code":"403 NG","system":"oxmis"},{"code":"403 NH","system":"oxmis"},{"code":"4120BD","system":"oxmis"},{"code":"4360B","system":"oxmis"},{"code":"4360D","system":"oxmis"},{"code":"4380HP","system":"oxmis"},{"code":"4419H","system":"oxmis"},{"code":"791 HP","system":"oxmis"}];
REQUIRED_CODES = 1;
